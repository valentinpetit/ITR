...
/* Task detection_contact_droit identifier */
#define detection_contact_droit_id 0
CONST(TaskType, AUTOMATIC) detection_contact_droit = detection_contact_droit_id;

/* Task detection_contact_gauche identifier */
#define detection_contact_gauche_id 1
CONST(TaskType, AUTOMATIC) detection_contact_gauche = detection_contact_gauche_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Task detection_contact_droit descriptor
 */
#define APP_Task_detection_contact_droit_START_SEC_CODE
#include "tpl_memmap.h"
/*
 * Task detection_contact_droit function prototype
 */
FUNC(void, OS_APPL_CODE) detection_contact_droit_function(void);
#define APP_Task_detection_contact_droit_STOP_SEC_CODE
#include "tpl_memmap.h"
 ...
 */
/*
 * Task detection_contact_droit stack
 */
#define APP_Task_detection_contact_droit_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) detection_contact_droit_stack_zone[500/sizeof(tpl_stack_word)];
#define APP_Task_detection_contact_droit_STOP_SEC_STACK
#include "tpl_memmap.h"

#define detection_contact_droit_STACK {detection_contact_droit_stack_zone, 500}

/*
 * Task detection_contact_droit context
 */
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_context, OS_VAR) detection_contact_droit_int_context;

#define detection_contact_droit_CONTEXT &detection_contact_droit_int_context
...
/*
 * Static descriptor of task detection_contact_droit
 */
CONST(tpl_proc_static, OS_CONST) detection_contact_droit_task_stat_desc = {
  /* context                  */  detection_contact_droit_CONTEXT,
  /* stack                    */  detection_contact_droit_STACK,
  /* entry point (function)   */  detection_contact_droit_function,
  /* internal ressource       */  NULL,
  /* task id                  */  detection_contact_droit_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task detection_contact_droit
 */
VAR(tpl_proc, OS_VAR) detection_contact_droit_task_desc = {
  /* resources                      */  NULL,
...
/*-----------------------------------------------------------------------------
 * Task detection_contact_gauche descriptor
 */
#define APP_Task_detection_contact_gauche_START_SEC_CODE
#include "tpl_memmap.h"
/*
 * Task detection_contact_gauche function prototype
 */
FUNC(void, OS_APPL_CODE) detection_contact_gauche_function(void);
#define APP_Task_detection_contact_gauche_STOP_SEC_CODE
#include "tpl_memmap.h"
 ...
 */
/*
 * Task detection_contact_gauche stack
 */
#define APP_Task_detection_contact_gauche_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) detection_contact_gauche_stack_zone[500/sizeof(tpl_stack_word)];
#define APP_Task_detection_contact_gauche_STOP_SEC_STACK
#include "tpl_memmap.h"

#define detection_contact_gauche_STACK {detection_contact_gauche_stack_zone, 500}

/*
 * Task detection_contact_gauche context
 */
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_context, OS_VAR) detection_contact_gauche_int_context;

#define detection_contact_gauche_CONTEXT &detection_contact_gauche_int_context
...
/*
 * Static descriptor of task detection_contact_gauche
 */
CONST(tpl_proc_static, OS_CONST) detection_contact_gauche_task_stat_desc = {
  /* context                  */  detection_contact_gauche_CONTEXT,
  /* stack                    */  detection_contact_gauche_STACK,
  /* entry point (function)   */  detection_contact_gauche_function,
  /* internal ressource       */  NULL,
  /* task id                  */  detection_contact_gauche_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
  /* task base priority       */  1,
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task detection_contact_gauche
 */
VAR(tpl_proc, OS_VAR) detection_contact_gauche_task_desc = {
  /* resources                      */  NULL,
#if WITH_MEMORY_PROTECTION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_MEMORY_PROTECTION */
...
tpl_stat_proc_table[TASK_COUNT+ISR_COUNT+1] = {
  &detection_contact_droit_task_stat_desc,
  &detection_contact_gauche_task_stat_desc,
...
tpl_dyn_proc_table[TASK_COUNT+ISR_COUNT+1] = {
  &detection_contact_droit_task_desc,
  &detection_contact_gauche_task_desc,
  &task1_task_desc,
...
CONSTP2CONST(char, AUTOMATIC, OS_APPL_DATA) proc_name_table[TASK_COUNT + ISR_COUNT] = {
  "detection_contact_droit",
  "detection_contact_gauche",
  "task1",
  "isr_button_left",
  "isr_button_right",
  "isr_button_start",
